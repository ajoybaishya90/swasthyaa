<?php
	...
	if($r){
		...
		$query = "INSERT INTO populations (Contact , Diabetes , Tobacco , Prison , Miner , Migrant  , Refugee , Urban , Health_worker , Other , OtherValue) 
		VALUES  (:Contact , :Diabetes , :Tobacco , :Prison , :Miner , :Migrant  , :Refugee , :Urban , :Health_worker , :Other , :OtherValue)";
		...
		$result->bindValue(':OtherValue' , $otherValue);
		...
		if($r){
			...
			$result->execute();
			header("location: ../new_patient.php?successHealthInfo");
		}
	}else{
			header("location: ../new_patient.php?failHealthInfo");
	    }
	$conn = null;
