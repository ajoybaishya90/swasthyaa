			...
			<div class="row" style="margin-left : 40px;">
				<div class="col-md-12 col-lg-12">
					...
					<table class="table" >
						<tbody>
							<tr>
								<td style="width : 33%"><input type="checkbox" value="1" name="testList[]" id="1">&nbsp;&nbsp;&nbsp;Microscopy</td>
								<td style="width : 33%"><input type="checkbox" value="2" name="testList[]" id="2">&nbsp;&nbsp;&nbsp;TST</td>
								<td style="width : 33%"><input type="checkbox" value="3" name="testList[]" id="3">&nbsp;&nbsp;&nbsp;IGRA</td>
							</tr>
							<tr>
								<td style="width : 33%"><input type="checkbox" value="4" name="testList[]" id="4">&nbsp;&nbsp;&nbsp;CHEST X RAY</td>
								<td style="width : 33%"><input type="checkbox" value="5" name="testList[]" id="5">&nbsp;&nbsp;&nbsp;CYTOPATHOLOGY</td>
								<td style="width : 33%"><input type="checkbox" value="6" name="testList[]" id="6">&nbsp;&nbsp;&nbsp;HISTOPATHOLOGY</td>
							</tr>
							<tr>
								<td style="width : 33%"><input type="checkbox" value="7" name="testList[]" id="7">&nbsp;&nbsp;&nbsp;CBNAAT</td>
								<td style="width : 33%"><input type="checkbox" value="8" name="testList[]" id="8">&nbsp;&nbsp;&nbsp;CULTURE</td>
								<td style="width : 33%"><input type="checkbox" value="9" name="testList[]" id="9">&nbsp;&nbsp;&nbsp;DST</td>
							</tr>
							<tr>
								<td style="width : 33%"><input type="checkbox" value="10" name="testList[]" id="10">&nbsp;&nbsp;&nbsp;LINE PROBE ASSAY</td>
								<td style="width : 33%"><input type="checkbox" value="11" name="testList[]" id="11">&nbsp;&nbsp;&nbsp;GENE SEQUENCING</td>
								<td style="width : 33%"><input type="checkbox" value="12" name="testList[]" id="12">&nbsp;&nbsp;&nbsp;OTHER</td>
							</tr>													
						</tbody>
					</table>
				</div>
			...
			<div class="row" style="margin-left : 40px; margin-bottom : 50px;">
				<div class="col-md-12 col-lg-12">
					<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
						...
						<input type="button" class="btn btn-primary" value="UPDATE REQUESTED TEST" onclick="forwardToLT();" id="testBtn">
					</div>
				</div>
			</div>
        </div>                        
