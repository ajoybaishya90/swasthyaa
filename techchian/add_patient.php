...
<link href="../assets/css/techchian/new_patient.css" rel="stylesheet">
<link href="../assets/css/technician/breadcum.css" rel="stylesheet">
...
$(document).ready(function() {
	...
	$('#pinfo').css("background" , '#f1635d');
	$('#hinfo').css("background" , '#dee2e8');
	$('#rinfo').css("background" , '#dee2e8');
	$('#referralDetailsBtn').css("color" , '#000');
	$('#healthDetailsBtn').css("color" , '#000');
	
	$('#referralIcon').attr("src", '../assets/image/editw.png');
	$('#healthDetailsBtn').prop("disabled",true);
	$('#referralDetailsBtn').prop("disabled",true);
	
	var url = "http://localhost/swasthyaa/techchian/add_patient.php";
	...
	if(document.URL == successpersonalInfo){
		$('#pinfo').css("background" , '#dee2e8');
		$('#personalDetailsBtn').css("color" , '#000');
		$('#hinfo').css("background" , '#f1635d');
		$('#hinfo').css("opacity" , '50%');
		$('#healthDetailsBtn').css("color" , '#fff');
		$('#rinfo').css("background" , '#dee2e8');
		$('#referralDetailsBtn').css("color" , '#000');
	...
	if(document.URL == successhealthInfo){
		...
		$('#hinfo').css("background" , '#dee2e8');
		$('#healthDetailsBtn').css("color" , '#000');
		$('#rinfo').css("background" , '#f1635d');
		$('#referralDetailsBtn').css("color" , '#fff');
		$('#healthDetailsBtn').prop("disabled",true);
		$('#personalDetailsBtn').prop("disabled",true);
	...
	$.ajax({
		...
		success: function(data){ 
            for(var i in data){
				...
				$('#hfList').append('<option value="'+data[i].ID+'">'+data[i].Name+'</option>');
			}
		}		
	});
}
	...
	<div id="sidebar-wrapper" class="col-md-2" style="">
        <div id="sidebar">
            <ul class="nav list-group">
				...
				<li class="active">
					<a class="" href="add_patient.php"><img src="../assets/image/editw.png" id="addpIcon">&nbsp;&nbsp;Add Private Patient Details</a>
				</li>
				<li>
        ...
        <div id="main">
			<div class="row form-group" style="height: 65px; border-top: 11px solid #606c38; background-color: #f4f4f5;  box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.14);">
				<div class="col-xs-8 col-sm-8 col-md-9 col-lg-9" style="">
					<div class="btn-group btn-breadcrumb" style="margin-left : 50px;; margin-top : 7px; border-color:none !important;">
						<a href="#" class="btn btn-info" id="pinfo" style="border : none;"><input type="button" class="btn btn-primary" value="PERSONAL DETAILS" id="personalDetailsBtn" style="background : transparent; color : #fff;"/></a>
						<a href="#" class="btn btn-info" id="hinfo" style="border : none;"><input type="button" class="btn btn-info" value="HEALTH DETAILS" id="healthDetailsBtn" style="background : transparent; color : #fff;"/></a>
						<a href="#" class="btn btn-info" id="rinfo" style="border : none;"><input type="button" class="btn btn-primary" value="REFERRAL DETAILS" id="referralDetailsBtn" style="background : transparent; color : #fff;"/></a>
					</div>
				</div>
						...
						<div class="" id="personalDetailsForm">
							...
							<div class="form-inline" style="margin-top : 20px;">
								<div class="form-group">
									...
									<select name="birthMonth" id="birthMonth" style="margin-left : 0px;" class="form-control" required>
									...
									<select name="birthYear" id="birthYear" style="margin-left : 0px;" placeholder="Year" class="form-control" onchange="calculateAge();" required>
									...
									<input name="age" id="age"  style="margin-left : 0px;" type="number" class="form-control" placeholder="Age" value="">
								</div>                                        
							</div>
							...
							<div class="form-inline">
								<div class="form-group">
									<input name="pin" id="pin" type="text" class="form-control" style="" placeholder="Enter PIN Code" value="" maxlength="6" size="6">            
									<select name="hfList" id="hfList" class="form-control" style="margin-left : 20px;">
									</select>
								</div>			 
							</div>
							<div class="form-inline" style="margin-top :20px;">
								<div class="form-group">            
									<select name="district" id="district" class="form-control" style="">
										<option value="Kamrup">Kamrup  </option>
										<option value="Barpeta">Barpeta</option>
									</select>
									<select name="city" id="city" class="form-control" style="margin-left : 20px;">
							...
							<div class="input-group">
							  ...
							  <input type="text" name="familyNumber" id="familyNumber" placeholder="Family mobile no." class="form-control" maxlength="10" value="">
							</div> 
		
							<div class="input-group" style="margin-top : 20px; margin-bottom : 30px;">
								<label>For Patient mobile verification call on</label>	<br />									
								<label> <span style="color:#d0011b; font-size: 18px;">9999555500</span> from patient registered mobile number.</label><br />                                     										 
