...
function saveCbnaatData(){
	var sample = $("input[name=sample]:checked").val();
	var mtb = $("input[name=mtb]:checked").val();
	var rif = $("input[name=rif]:checked").val();
	var test = $("input[name=test]:checked").val();
	var code = $('#code').val();
	
	$.ajax({
		type: "POST",
		data: { pid:pid , did:did , sample : sample , mtb : mtb , rif : rif , test : test , code : code },
		url: 'model/saveCbnaatData.php',
		dataType: 'JSON',
        ...
        <div id="main">
			...
			<div class="row" style="margin-left : 40px;">
				<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
					<div class="form-group" style="margin-top : 20px;">
						<label>Cartridge Based Nucleic Acid Amplification Test (CBNAAT)</label><br /><br />
						<label>Sample</label><br />
						<input type="radio" name="sample" value="A" checked>&nbsp;&nbsp;&nbsp;&nbsp;A&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="sample" value="B" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;B<br /><br />
						<label>M. Tuberculosis</label><br />
						<input type="radio" name="mtb" value="Detected" checked>&nbsp;&nbsp;&nbsp;&nbsp;Deteced&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="mtb" value="Not Detected" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Not Detected&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="mtb" value="NA" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NA<br /><br />
						<label>Rif Resistance</label><br />
						<input type="radio" name="rif" value="Detected" checked>&nbsp;&nbsp;&nbsp;&nbsp;Deteced&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rif" value="Not Detected" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Not Detected&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rif" value="Indeterminate" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Indeterminate&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rif" value="NA" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NA<br /><br />
						<label>Test</label><br />
						<input type="radio" name="test" value="No  Result" checked>&nbsp;&nbsp;&nbsp;&nbsp;No Result&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="test" value="Invalid" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invalid&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="test" value="Error" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Error&nbsp;&nbsp;&nbsp;&nbsp;
						Error Code&nbsp;&nbsp;<input type="text" name="code" value="code" id="code" placeholder="Enter Code">						
					</div>
				</div>
			</div>
			...
			<div class="row" style="margin-top : 20px; margin-bottom : 60px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align:center;">					
						...
						<input type="button" class="btn btn-primary" value="SAVE AND NEXT" onclick="saveCbnaatData();">
				</div>
			</div>			
        </div>                        
    </div>
