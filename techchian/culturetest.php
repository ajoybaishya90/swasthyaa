...
function saveCultureTestData(){
	var ctype = $("input[name=ctype]:checked").val();
	var labno = $('#labno').val();
	var negative = $('#negative').val();
	var positive = $('#positive').val();
	var ntm = $('#ntm').val();
	var contamination = $('#contamination').val();
	
	$.ajax({
		type: "POST",
		data: {pid:pid, did:did , ctype:ctype, labno:labno, negative:negative, positive:positive, ntm:ntm, contamination:contamination},
		url: 'model/saveCultureTestData.php',
		dataType: 'JSON',
        ...
        <div id="main">
			...
			<div class="row" style="margin-left : 40px;">
				<div class="col-lg-12 col-md-12 col-sm-12 form-group" style="margin-top : 30px; padding-left:0; padding-right:0">
					...
					<input type="radio" name="ctype" value="LJ" checked>&nbsp;&nbsp;&nbsp;&nbsp;LJ&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="ctype" value="LC" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LC<br /><br />
				</div>
			</div>
			<div class="row" style="margin-left : 40px;">
				<div class="col-lg-12 col-md-12 col-sm-12 form-group" style="padding-left:0; padding-right:0">
					<label>Lab Serial Number</label>
					<input type="text" name="labno" id="labno" value="" class="form-control" placeholder="Enter Serial Number" style="width : 450px;">
				</div>
			</div>
			<div class="row" style="margin-left : 40px;">
				<div class="col-md-3 col-lg-3" style="padding-left:0;">
					<label>Negative</label>
					<input type="text" name="negative" id="negative" class="form-control" style="width : 200px;" placeholder="Enter Result"/>
				</div>
				<div class="col-md-3 col-lg-3">
					<label>Positive</label>
					<input type="text" name="positive" id="positive" class="form-control" style="width : 200px;" placeholder="Enter Result"/>
				</div>
			</div>
			<div class="row" style="margin-left : 40px; margin-top : 20px;">
				<div class="col-md-3 col-lg-3" style="padding-left:0;">
					<label>NTM (write species)</label>
					<input type="text" name="ntm" id="ntm" class="form-control" style="width : 200px;" placeholder="Enter Result"/>
				</div>
				<div class="col-md-3 col-lg-3">
					<label>Contamination</label>
					<input type="text" name="contamination" id="contamination" class="form-control" style="width : 200px;" placeholder="Enter Result"/>
				</div>
			</div>						
			<div class="row" style="margin-top : 20px; margin-bottom : 60px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align:center;">					
						...
						<input type="button" class="btn btn-primary" value="SAVE AND NEXT" onclick="saveCultureTestData();">
				</div>
			</div>			
        </div>                        
    </div>
