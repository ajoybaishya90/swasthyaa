...
function saveMDRDiagnosisData(){
	var presumptive = $('input[name=presumptive]:checked').val();
	...
	var followup = $('input[name=followup]:checked').val();
	if(followup == 'Yes'){}
	else{ followup = 'No';}
	
	var discordance = $('input[name=discordance]:checked').val();
	if(discordance == 'Yes'){}
	else{ discordance = 'No';}
	
	$.ajax({
		type: "POST",
		data: { pid : pid , presumptive : presumptive , diagnosis : diagnosis , contact : contact , followup : followup , discordance : discordance},
		url: 'model/saveMDRDiagnosisData.php',
		dataType: 'JSON',
        ...
        <div id="main">
			...
			<div class="row" style="margin-left : 40px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="form-group" style="margin-top : 20px;">
						<label>MDR TB - Drug Susceptibility Test</label><br /><br />
						<label>Presumptive MDR TB</label><br /><br />
						<input type="radio" name="presumptive" value="New" checked>&nbsp;&nbsp;&nbsp;&nbsp;New&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="presumptive" value="Previously Treated" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Previously Treated&nbsp;&nbsp;&nbsp;&nbsp;
						<br /><br />
						<label>Kindly Select</label><br /><br />
						<table>
							<tr>
								<td><input type="checkbox" value="Yes" name="diagnosis">&nbsp;&nbsp;&nbsp;At Diagnosis</td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="contact">&nbsp;&nbsp;&nbsp;Contact of MDR / RR TB</td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="followup">&nbsp;&nbsp;&nbsp;Follow Up Sm +ve</td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="discordance">&nbsp;&nbsp;&nbsp;Discordance Resolution</td>
							</tr>
						</table>
					</div>
				</div>
			...
			<div class="row" style="margin-top : 20px; margin-bottom : 40px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align:center;">					
						...
						<input type="button" class="btn btn-primary" value="FORWARD TO DOCTOR" onclick="saveMDRDiagnosisData();">
				</div>
			</div>			
        </div>                        
    </div>
