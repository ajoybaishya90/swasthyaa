...
function saveMDRFollowUpData(){
	...
	$.ajax({
		...
		url: 'model/saveMDRFollowUpData.php',
		dataType: 'JSON',
        ...
        <div id="main">
			...
			<div class="row" style="margin-top : 20px; margin-bottom : 40px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align:center;">					
						...
						<input type="button" class="btn btn-primary" value="FORWARD TO DOCTOR" onclick="saveMDRFollowUpData();">
				</div>
			</div>			
        </div>                        
    </div>
