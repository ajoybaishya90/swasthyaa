<?php
    if(isset($_POST['pid'])){
		...
		$query = "INSERT INTO follow_mdr (PID , INH , MDR , Shorter_regimen , Modified_regimen , xdr_TB , Mixed_pattern , Regimen_fq , Drug_XDR , Drug_failure_MDR , Drug_failure_XDR , Drug_mixed_pattern , treatment , tvalue , date) VALUES
