...
function saveNormalTbFollwUpdata(){
	var regimen = $('input[name=regimen]:checked').val();
	var reason = $('input[name=reason]:checked').val();
	var post = $('input[name=post]:checked').val();	
	
	$.ajax({
		type: "POST",
		data: { pid : pid , regimen : regimen , reason : reason , post : post},
		url: 'model/saveNormalFollowUpData.php',
		dataType: 'JSON',
        ...
        <div id="main">
			...
			<div class="row" style="margin-left : 40px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="form-group" style="margin-top : 20px;">
						<label>Follow Up - Smear and Culture</label><br /><br />
						<label>Regimen</label><br /><br />
						<input type="radio" name="regimen" value="New" checked>&nbsp;&nbsp;&nbsp;&nbsp;New&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="regimen" value="Previously Treated" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Previously Treated&nbsp;&nbsp;&nbsp;&nbsp;
						<br /><br />
						<label>Reason</label><br /><br />
						<input type="radio" name="reason" value="End IP" checked>&nbsp;&nbsp;&nbsp;&nbsp;End IP&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="reason" value="End CP" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;End CP&nbsp;&nbsp;&nbsp;&nbsp;
						<br /><br />
						<label>Post Treatment</label><br /><br />
						<input type="radio" name="post" value="6m" checked>&nbsp;&nbsp;&nbsp;&nbsp;6m&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="post" value="12m">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12m&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="post" value="18m">&nbsp;&nbsp;&nbsp;&nbsp;18m&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="post" value="24m">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;24m&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
				</div>
			</div>
			...
			<div class="row" style="margin-top : 20px; margin-bottom : 40px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align:center;">					
						...
						<input type="button" class="btn btn-primary" value="FORWARD TO DOCTOR" onclick="saveNormalTbFollwUpdata();">
				</div>
			</div>			
        </div>                        
    </div>
