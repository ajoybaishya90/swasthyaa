...
function saveXDRDiagnosisData(){
	var mdrtb = $('input[name=mdrtb]:checked').val();
	if(mdrtb == 'Yes'){}
	else{ mdrtb = 'No';}
	
	var culturepositive = $('input[name=culturepositive]:checked').val();
	if(culturepositive == 'Yes'){}
	else{ culturepositive = 'No';}
	
	var persistanceculture = $('input[name=persistanceculture]:checked').val();
	if(persistanceculture == 'Yes'){}
	else{ persistanceculture = 'No';}
	
	var reversion = $('input[name=reversion]:checked').val();
	if(reversion == 'Yes'){}
	else{ reversion = 'No';}
	
	var regimenfailure = $('input[name=regimenfailure]:checked').val();
	if(regimenfailure == 'Yes'){}
	else{ regimenfailure = 'No';}
	...
	$.ajax({
		type: "POST",
		data: { pid : pid , mdrtb : mdrtb , culturepositive : culturepositive , persistanceculture : persistanceculture , reversion : reversion , regimenfailure : regimenfailure , treatment : treatment , resolution : resolution , month : month },
		url: 'model/saveXDRDiagnosisData.php',
		dataType: 'JSON',
        ...
        <div id="main">
			...
			<div class="row" style="margin-left : 40px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="form-group" style="margin-top : 20px;">
						<label>XDR TB - Presumtive H mono/poly</label><br /><br />
						<label>Kindly Select</label><br /><br />
						<table>
							<tr>
								<td><input type="checkbox" value="Yes" name="mdrtb">&nbsp;&nbsp;&nbsp;MDR/RR TB Diagnosis</td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="culturepositive">&nbsp;&nbsp;&nbsp;>= 4 months culture positive</td>
							</tr>
							<tr>
								<td><div class="form-inline"><input type="checkbox" value="Yes" name="persistanceculture">&nbsp;&nbsp;&nbsp;3 monthly for persistance culture positive&nbsp;&nbsp;<input name="month" id="month" type="text" value=""  placeholder="Enter Months" class="form-control"></div></td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="reversion">&nbsp;&nbsp;&nbsp;Culture reversion</td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="regimenfailure">&nbsp;&nbsp;&nbsp;Failure of MDR/RR-TB regimen</td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="treatment">&nbsp;&nbsp;&nbsp;Recurrent case of second line treatment</td>
							</tr>
							<tr>
								<td><input type="checkbox" value="Yes" name="resolution">&nbsp;&nbsp;&nbsp;Discordance resolution</td>
							</tr>				
					</table>
					</div>
				</div>
			...
			<div class="row" style="margin-top : 20px; margin-bottom:40px;">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align:center;">					
						...
						<input type="button" class="btn btn-primary" value="FORWARD TO DOCTOR" onclick="saveXDRDiagnosisData();">
				</div>
			</div>			
        </div>                        
    </div>
